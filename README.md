...
- 前端演示：https://ai-resume-analyzer-umber-beta.vercel.app
- 后端健康检查：https://ai-resu-backend-cacewsdnlt.cn-hangzhou.fcapp.run/api/health
- API 文档：https://ai-resu-backend-cacewsdnlt.cn-hangzhou.fcapp.run/docs
